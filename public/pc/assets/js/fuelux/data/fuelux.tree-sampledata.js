...
var tree_data = {
	'for-sale' : {name: '国外部', type: 'folder'}	,
	'vehicles' : {name: '国内部', type: 'folder'}	,
	'rentals' : {name: '启智数学', type: 'folder'}	,
	'real-estate' : {name: '少儿部', type: 'folder'}	,
	'pets' : {name: '财务部', type: 'folder'}	,
	'tickets' : {name: '审核部', type: 'folder'}	,
	//'services' : {name: 'Services', type: 'item'}	,
	//'personals' : {name: 'Personals', type: 'item'}
};
tree_data['rentals']['additionalParameters'] = {
	'children' : {
		'assistant' : {name: '助教申报', type: 'item'},
		'foreign-teachers' : {name: '外教申报', type: 'item'},
	}
};
tree_data['tickets']['additionalParameters'] = {
	'children' : {
		'to-examine' : {name: '审核', type: 'item'},
		'to-review' : {name: '复核', type: 'item'},
	}
};
