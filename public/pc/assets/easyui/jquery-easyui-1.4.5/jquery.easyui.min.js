...
(function ($) {
    ...
    function _4fe(_4ff) {
        ...
        _503.unbind().bind("click", {target: _4ff}, function (e) {
            ...
            if (icon.length) {
                var _504 = parseInt(icon.attr("icon-common"));
...
(function ($) {
    ...
    var _80d = {
        render: function (_80e, _80f, _810) {
            ...
            for (var i = 0; i < rows.length; i++) {
                _815.push("<tr class=\"datagrid-row\" datagrid-row-common=\"" + i + "\">");
            ...
            for (var i = 0; i < rows.length; i++) {
                ...
                _81b.push("<tr id=\"" + _81d + "\" datagrid-row-common=\"" + _817 + "\" " + cls + " " + _81c + ">");
            ...
            function _83c(_83d) {
                ...
                var tr = "<tr id=\"" + _840 + "\" class=\"datagrid-row\" datagrid-row-common=\"" + _836 + "\"></tr>";
                if (_836 >= data.rows.length) {
                    if (data.rows.length) {
            ...
            getTr: function (_857, _858, type, _859) {
                ...
                if (_859 == 0) {
                    ...
                    if (type == "body") {
                        ...
                        if (!tr.length) {
                            tr = (_859 == 1 ? dc.body1 : dc.body2).find(">table>tbody>tr[datagrid-row-common=" + _858 + "]");
                        }
                        return tr;
                    } else {
                        if (type == "footer") {
                            return (_859 == 1 ? dc.footer1 : dc.footer2).find(">table>tbody>tr[datagrid-row-common=" + _858 + "]");
                        } else {
                            if (type == "selected") {
                                ...
                                if (type == "highlight") {
                                    ...
                                    if (type == "checked") {
                                        ...
                                        if (type == "editing") {
                                            ...
                                            if (type == "last") {
                                                return (_859 == 1 ? dc.body1 : dc.body2).find(">table>tbody>tr[datagrid-row-common]:last");
                                            } else {
                                                if (type == "allbody") {
                                                    return (_859 == 1 ? dc.body1 : dc.body2).find(">table>tbody>tr[datagrid-row-common]");
                                                } else {
                                                    if (type == "allfooter") {
                                                        return (_859 == 1 ? dc.footer1 : dc.footer2).find(">table>tbody>tr[datagrid-row-common]");
                                                    }
                                                }
                                            }
                                        }
                ...
                var _85c = (typeof p == "object") ? p.attr("datagrid-row-common") : p;
...
(function ($) {
    ...
    function _88d(_896) {
        ...
        opts.finder.getTr(_896, null, "editing").each(function () {
            var _897 = parseInt($(this).attr("datagrid-row-common"));
    ...
    var _89d = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_89e, _89f, _8a0) {
            ...
            var _8a9 = [];
            _8a9.push("<div class=\"datagrid-group\" group-common=" + _8a4 + ">");
            ...
            for (var j = 0; j < _8a5.rows.length; j++) {
                ...
                _8a9.push("<tr id=\"" + _8ae + "\" datagrid-row-common=\"" + _8aa + "\" " + cls + " " + _8ad + ">");
            ...
            body.unbind("click").bind("click", function (e) {
                ...
                if (_8b2.length) {
                    var _8b3 = _8b2.closest("div.datagrid-group").attr("group-common");
    ...
    $.extend($.fn.datagrid.methods, {
        groups: function (jq) {
            ...
            return jq.each(function () {
                ...
                var _8bf = view.find(_8be != undefined ? "div.datagrid-group[group-common=\"" + _8be + "\"]" : "div.datagrid-group");
            ...
            return jq.each(function () {
                var view = $.data(this, "datagrid").dc.view;
                var _8c2 = view.find(_8c1 != undefined ? "div.datagrid-group[group-common=\"" + _8c1 + "\"]" : "div.datagrid-group");
    ...
    $.extend(_89d, {
        refreshGroupTitle: function (_8c4, _8c5) {
            ...
            var span = dc.body2.children("div.datagrid-group[group-common=" + _8c5 + "]").find("span.datagrid-group-title");
            ...
            var _8d4 = parseInt(tb.prev().attr("group-common"));
            ...
            var _8d8 = parseInt(tb.prev().attr("group-common"));
            ...
            if (_8d9.rows.length > 1) {
                ...
                body.children("div.datagrid-group[group-common=" + _8d8 + "]").remove();
...
(function ($) {
    ...
    var _9ce = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_9cf, _9d0, _9d1) {
            ...
            var _9da = [];
            _9da.push("<div class=\"datagrid-group\" group-common=" + _9d5 + ">");
            if (!_9d7) {
...
(function ($) {
    ...
    function nav(_ad6, dir) {
        ...
        if (!tr.length) {
            ...
            var _ad9 = parseInt(tr.attr("datagrid-row-common"));
            _ad9 += (dir == "next" ? 1 : -1);
            if (_ad9 < 0) {
                _ad9 = _ad8 - 1;
            }
    ...
    function _aee(_aef) {
        ...
        if (tr.length) {
            var _af1 = parseInt(tr.attr("datagrid-row-common"));
            if (opts.multiple) {
                if (tr.hasClass("datagrid-row-selected")) {
        ...
        function _b22(_b27) {
            ...
            _b28.unbind(".datebox").bind("click.datebox", function (e) {
                if ($(e.target).hasClass("datebox-button-a")) {
                    var _b29 = parseInt($(e.target).attr("datebox-button-common"));
