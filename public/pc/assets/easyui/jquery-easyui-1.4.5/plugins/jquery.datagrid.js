...
function _9b(tr){
if(tr.attr("datagrid-row-common")){
return parseInt(tr.attr("datagrid-row-common"));
}else{
...
for(var i=0;i<rows.length;i++){
_213.push("<tr class=\"datagrid-row\" datagrid-row-common=\""+i+"\">");
...
_219.push("<tr id=\""+_21b+"\" datagrid-row-common=\""+_215+"\" "+cls+" "+_21a+">");
...
tr.attr("datagrid-row-common",i+1);
...
var tr="<tr id=\""+_23e+"\" class=\"datagrid-row\" datagrid-row-common=\""+_234+"\"></tr>";
if(_234>=data.rows.length){
if(data.rows.length){
...
tr.removeClass("datagrid-row").removeAttr("datagrid-row-common");
...
if(!tr.length){
tr=(_257==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-common="+_256+"]");
}
return tr;
}else{
if(type=="footer"){
return (_257==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-common="+_256+"]");
}else{
if(type=="selected"){
...
if(type=="last"){
return (_257==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-common]:last");
}else{
if(type=="allbody"){
return (_257==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-common]");
}else{
if(type=="allfooter"){
return (_257==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-common]");
}
}
}
}
...
var _25a=(typeof p=="object")?p.attr("datagrid-row-common"):p;
