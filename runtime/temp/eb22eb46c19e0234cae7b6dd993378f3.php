<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"app/home\view\do_check\addlog.html";i:1498818464;s:30:"app/home\view\common\base.html";i:1498787932;}*/ ?>
﻿<!DOCTYPE html>
        ...
        $('#doPost').click(function(){ // 点击提交
            ...
            $.post("<?php echo url('home/do_check/doAddLog'); ?>", $('#goToPost').serialize(), function(data){ // 异步post，方便加tips
                if (data) {
                    ...
                    $('#doPost').html('提交');
                    setTimeout(function() {
                        window.location.href = "<?php echo url('home/do_check/index'); ?>";
                    }, 1000)
                } else {
                    sweetAlert('哎呀...', '出了一点小状况，过一会再试吧', 'error');
                    $('#doPost').html('提交');
